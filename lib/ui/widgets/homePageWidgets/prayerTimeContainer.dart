...
class PrayerTimeContainer extends StatelessWidget {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(myLocale == AppConstants.TR_LOCALE ? districtName + " " + LocaleKeys.prayerTime.tr() : LocaleKeys.prayerTime.tr() + " " + districtName,
                style: Theme.of(context).textTheme.headline6),
            Helper.sizedBoxH10,
            Table(
              defaultColumnWidth: FractionColumnWidth(.30),
              children: <TableRow>[
                buildTableRow(context, tableWidget(context, imsak(iconColor)), LocaleKeys.imsak.tr(), prayerTime[0]),
                buildTableRow(context, tableWidget(context, sun(iconColor)), LocaleKeys.sun.tr(), prayerTime[1]),
                buildTableRow(context, tableWidget(context, noon(iconColor)), LocaleKeys.noon.tr(), prayerTime[2]),
                buildTableRow(context, tableWidget(context, afternoon(iconColor)), LocaleKeys.afternoon.tr(), prayerTime[3]),
                buildTableRow(context, tableWidget(context, evening(iconColor)), LocaleKeys.evening.tr(), prayerTime[4]),
                buildTableRow(context, tableWidget(context, Icon(AppIcons.moon, size: 17)), LocaleKeys.moon.tr(), prayerTime[5]),
              ],
            ),
          ],
        ),
  ...
  TableRow buildTableRow(BuildContext context, Widget _icon, String _timeName, String _time) {
    return TableRow(
      children: [
        ...
        TableCell(child: Text(_time, textAlign: TextAlign.center, style: _buildTableTextStyle2(context)), verticalAlignment: TableCellVerticalAlignment.middle),
      ],
    );
  }
  ...
  TextStyle _buildTableTextStyle2(BuildContext context) => Theme.of(context).textTheme.subtitle1;
